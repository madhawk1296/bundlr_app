...
export default function CollectionInfo({ currencies, collection }) {
    ...
    return (
        <div className="w-fit min-h-[125px] border-2 border-gray-200 rounded-xl px-[15px] py-[10px] flex flex-col">
            <div className="w-full flex flex-col gap-6">
                <div className="w-full flex gap-10 justify-evenly">
                    <div className="relative flex flex-col gap-2">
                        <Image className='rounded-xl' alt='Collection Image' src={collection.imageUrl ? collection.imageUrl : '/no_image.jpeg'} width={100} height={100} />
