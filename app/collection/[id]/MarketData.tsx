...
export default function MarketData({ title, value, currency=false }) {
    return (
        <div className="relative min-w-[140px] py-[10px] px-[15px] flex flex-col gap-1 items-center border-2 border-gray-200 rounded-xl">
            ...
            <div className="relative h-[19px] flex gap-1 items-center">
                ...
                <h1 className="font-bold text-xl text-gray-700">{value}</h1>
            </div>
        </div>
    )
}