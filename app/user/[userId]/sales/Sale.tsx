...
export default async function Listing({ userId, bundle }) {
    const { prices, bundleId, tokenStandard, collection: {address: collectionId} } = bundle;
    ...
    return (
        <Link href={`/bundle/${userId}/${collectionId}/${bundleId}`}>
